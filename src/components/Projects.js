...
let projects = [
    ...
    {image: wordsurge, description: "Wordsurge is a platform that procedurally generates word search puzzles based on lists of words uploaded by users.", techs: ["React", "Sass", "Node", "Knex", "Postgres", "Heroku"], url: "https://wordsurge.xyz", github: "https://github.com/pt11-word-find"},
    ...
    {image: zecmailer, description: "Zecmailer aims to increase usage of the Zcash blockchain by allowing users to send Zcash and memos to multiple recipeints. This enables anyone to easily send encrypted newsletters on a trustless blockchain.", techs: ["Javascript", "HTML", "CSS", "zcashd"], url: "https://zecmailer.com", github: "https://github.com/michaelharms6010/zecmailer"}]
