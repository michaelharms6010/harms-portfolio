...
let projects = [
    ...
    {image: wordsurge, description: "Wordsurge is a platform that procedurally generates word search puzzles based on lists of words uploaded by users. Technologies used: React, Sass, Node, Knex, Postgres, Heroku", url: "https://wordsurge.xyz", github: "https://github.com/pt11-word-find"},
